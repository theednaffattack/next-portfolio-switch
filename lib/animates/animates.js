...
export default class Animates extends React.Component {
    ...
    this.timeline = new TimelineMax()
      ...
      .add(
        TweenMax.to(
          el,
          1,
          Object.assign({}, Animates.animationStates.beforeEnter, {
      ...
      .add(
        TweenMax.to(
          el,
          1,
          Object.assign({}, Animates.animationStates.idle, {
            ease: Linear.easeNone
          })
        )
      )
      ...
      .add(
        TweenMax.to(
          el,
          1,
          Object.assign({}, Animates.animationStates.afterLeave, {
            ease: Linear.easeNone
          })
        )
      )
  ...
  render() {
    return (
      <div className={`animates ${this.props.className}`}>
