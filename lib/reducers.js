...
import {
  ...
  GET_WIKI_FULFILLED,
  GET_WIKI_REJECTED
} from "../ducks/wikisearch";
import {
  GET_WEATHER,
  GET_WEATHER_PENDING,
  GET_WEATHER_FULFILLED,
  GET_WEATHER_REJECTED
} from "../full_modules/Weather/modules/weather";
import {
  GET_POSITION,
...
const LOAD_MAIN_TIMER = "LOAD_MAIN_TIMER";
...
const START_MAIN_TIMER = "START_MAIN_TIMER";
...
const mainClock = d.toLocaleTimeString();
...
export default {
  ...
  pomodoro: (state = pomodoroInitialState, { type, payload = 60 }) => {
    switch (type) {
      case RESET_TIMER:
        return {
          ...state,
      ...
      case LOAD_MAIN_TIMER:
        return {
          ...state,
          mainClock: payload.newClockVal,
          timerIsRunning: payload.timerIsRunning
        };
      case START_MAIN_TIMER:
        return {
          ...state,
          timerIsRunning: true,
          mainClock: state.mainClock - 1
        };
      case STOP_TIMER:
        return {
          ...state,
      ...
      case INC_BREAK_CLOCK:
        return {
          ...state,
          breakClock: state.breakClock + payload
        };
      ...
      case INC_SESSION_CLOCK:
        return {
          ...state,
          sessionClock: state.sessionClock + payload
        };
  ...
  simon: (state = simonInitialState, { type, payload }) => {
    switch (type) {
      ...
      case RESET_GAMESET:
        return {
          ...state,
          gameset: simonInitialState.gameset
        };
      case MAKE_CHOICE:
        return {
          ...state,
